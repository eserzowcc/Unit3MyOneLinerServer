...
public class MainActivity extends Activity {
    ...
    public static final String MY_ONE_LINER_ACTION="edu.wcc.oneliner.ACTION";
    public static final String MY_RANDOM_ONE_LINER_ACTION="edu.wcc.random_oneliner.ACTION";
